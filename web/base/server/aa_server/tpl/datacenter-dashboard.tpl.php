...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        // get_event_status();
        // var response = {"systems_list": [["free",7],["active",3],["paused",0]],"disk_list": [["free",9800000],["active",200000],["paused",0]],"memory_list": [["total",87712],["used",12288]],"cpu_list": [["free",46],["active",4],["paused",0]],"network_list": [["free",27],["active",3],["paused",0]]};

        var memtotal = {memtotal};
        var memused = {memused};
        var memfree = memtotal - memused;

        var stotal = "{stotal}".split(" ")[0];
        var sused =  "{sused}".split(" ")[0];
        var sfree = stotal - sused;

        make_doughnut('disk', [["free",sfree],["used",sused]], "GB");
        make_doughnut('memory', [["free",memfree],["used",memused]], "GB");
        make_doughnut('cpu', [["free",0],["used",0]], "");
        make_doughnut('network', [["free",0],["used",0]], "");
    ...
    function renderDonutLegend(values,binding,units) {
        ...
        $.each(values, function(k,v) {
            legend.append(
                $('<li>').append(
                    $('<div>').addClass('legend-tile').attr('style', 'background:' + seriesColors[k]).append(v[0] + " " + units)
                )
            );
        });
        return legend;
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-9 data-center-load" style="background-color: #ffffff;">
        <!--Network Line Chart-->
        <!--===================================================-->
        <!-- <div id="demo-panel-network" class="panel" style="min-height: 34.7rem;">  -->
        <div id="demo-panel-network" class="col-lg-12">
            <div class="panel-heading col-lg-12">
                <h3 class="panel-title">Resource Consumption</h3>
            </div>

            <div class="col-sm-12 col-md-6 col-lg-3 dashboard pull-left" style="height: 30rem;">
                <div class="panel-heading">
                    <h3 class="panel-title">Services</h3>
                </div>
                <div id="chartdiv-inventory-memory-legend" class="donut-chart-legend"></div>
                <div id="chartdiv-inventory-memory" class="c3-chart" style="height: 20rem;"></div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 dashboard pull-left" style="height: 30rem;">
                ...
                <div id="chartdiv-inventory-cpu" class="c3-chart" style="height: 20rem;"></div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 dashboard pull-left" style="height: 30rem;">
                ...
                <div id="chartdiv-inventory-disk" class="c3-chart" style="height: 20rem;"></div>
            </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-3 dashboard pull-left" style="height: 30rem;">
                ...
                <div id="chartdiv-inventory-network" class="c3-chart" style="height: 20rem;"></div>
            </div>
        </div>

        <div id="demo-panel-network" class="panel" style="display:none;">
            <div class="panel-heading">
